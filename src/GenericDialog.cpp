...
GenericDialog::GenericDialog(const QString &Title,
                             ...
                             bool showFileSelectionButton, QWidget *parent)
    : QDialog(parent) {
  ...
  if (showFileSelectionButton) {
    ...
    connect(browseButton, &QPushButton::clicked, this,
            &GenericDialog::browseForFile);
    layout->addWidget(browseButton);
  }

  genericButtonBox = new QDialogButtonBox(
      QDialogButtonBox::Ok | QDialogButtonBox::Cancel, this);
  connect(genericButtonBox, &QDialogButtonBox::accepted, this,
          &QDialog::accept);
  connect(genericButtonBox, &QDialogButtonBox::rejected, this,
          &QDialog::reject);
  layout->addWidget(genericButtonBox);
  int padding = 30;
  setFixedSize(sizeHint() + QSize(padding, padding));
}
